import { CLASSES } from "./entities.js?v=__BUILD__";

export const ATTRS = ["might", "agility", "focus", "vitality"];

// Produce base combat stats from a hero's persistent data.
// Parity guarantee: at level 1, all attrs 0, no gear — result equals {...CLASSES[classKey]}.
export function deriveStats(hero) {
  const c = CLASSES[hero.classKey];
  if (!c) return {};
